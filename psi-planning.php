                                ...
                                if (mysqli_num_rows($result) > 0) {
                                    ...
                                    while($neighbor_sector = mysqli_fetch_assoc($result)) {
                                       // print_r($base_sector['azimuth']);
                                        ...
                                        $sectors[$neighbor_sector['sector']] = array('group' => $group, 'distance' => $distance, 'angle' => $angle, 'relative_angle' => $relative_angle);
                                        $index++;
                                    }
                                    asort($sectors);
...
<div class="main-area">
    ...
    <ul class="main-left-navigation">
        ...
        <li>
            <a class="active" href="psi-planning.php">PSI Planning</a>
        </li>
        <li>
